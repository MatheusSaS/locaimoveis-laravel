  ...
  <div class="row">
    <div class="col-md-5">
      <div class="project-info-box mt-0">
        <h5>{{$imoveis->cidade}} - {{$imoveis->bairro}}</h5>
        <p class="mb-0 text-justify">{{$imoveis->descricao}}</p>
      </div><!-- / project-info-box -->

      <div class="project-info-box">
        <p><b>Anunciante:</b> {{$user->name}}</p>
        <p><b>Data do anuncio:</b> {{$imoveis->created_at}}</p>
        <p class="mb-0"><b>Preço:</b> {{$imoveis->valor}}</p>
        <button class="btn button btn-lg px-4 gap-3 mt-4" data-bs-toggle="modal" data-bs-target="#exampleModal">Contactar vendedor</button>
        <!-- Modal -->
    ...
    <div class="col-md-7">
      <img src="{{ asset('assets/img/imoveis') }}/{{$imoveis->image}}" alt="project-image" class="rounded shadow">
      <div class="project-info-box">
        <p><b>Tipo:</b> {{$tipo->name}}</p>
        <h4 class="text-center text-danger">{{$imoveis->operacao}}</h4>
      </div><!-- / project-info-box -->
